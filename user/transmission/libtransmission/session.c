...
tr_sessionGetDefaultSettings( tr_benc * d )
{
    ...
    tr_bencDictAddInt ( d, TR_PREFS_KEY_DSPEED_KBps,                     250 );
    ...
    tr_bencDictAddInt ( d, TR_PREFS_KEY_DOWNLOAD_QUEUE_SIZE,             1 );
    ...
    tr_bencDictAddInt ( d, TR_PREFS_KEY_USPEED_KBps,                     250 );
...
tr_sessionInitImpl( void * vdata )
{
    ...
    **/
    ...
    tr_err( _( "%s %s started" ), TR_NAME, LONG_VERSION_STRING );
