...
<tr>
	<td>
		<input type="button" class="normal" value="Apply" id="oApply" onClick="ajaxPostForm('Changing operation mode needs to reboot you router. Do you want to proceed?', this.form, 'setmodeReloader', '/messages/rebooting.asp', ajaxShowProgress);">&nbsp;&nbsp;
