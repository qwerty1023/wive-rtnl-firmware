...
<tr id="div_wpa_algorithms" name="div_wpa_algorithms" style="visibility: hidden;">
	...
	<td>
		...
		<input name="cipher" id="cipher" value="2" type="radio" onClick="onWPAAlgorithmsClick(2)">TKIP/AES &nbsp;
	</td>
</tr>
...
<tr>
	<td>
		<input type="submit" class="normal" value="Apply" id="secureApply"> &nbsp; &nbsp;
		<input type="reset" class="normal" value="Cancel" id="secureCancel" onClick="window.location.reload();" >
