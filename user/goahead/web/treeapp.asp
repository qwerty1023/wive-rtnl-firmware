...
else
{
	...
	if (meshb == "1")
	{
		a.add(409, 400, _("treeapp mesh settings"),	"javascript:go('wireless/mesh.asp');");
	}
}
...
a.add(507, 500, _("treeapp miscellaneous"),			"javascript:go('services/misc.asp');");
...
if (usbb == "1")
{
	...
	if (printersrvb == "1")
		a.add(801, 800, _("treeapp printersrv"),	"javascript:go('usb/P910NDprintersrv.asp');");
        if (usbmodemb == "1")
		a.add(802, 800, _("treeapp usbmodem"),		"javascript:go('usb/USBmodem.asp');");
	if (storageb == "1")
	{
		a.add(850,   0, _("treeapp storage"),		"javascript:a.oo(850);");
		a.add(851, 850, _("treeapp disk"),			"javascript:go('usb/STORAGEdisk_admin.asp');");
		if (ftpb == "1")
...
a.add(903, 900, _("treeapp statistics"),			"javascript:go('adm/statistic.asp');");
a.add(904, 900, _("treeapp system command"),		"javascript:go('adm/system_command.asp');");
if (syslogb == "1")
{
	a.add(905, 900, _("treeapp system log"),		"javascript:go('adm/syslog.asp');");
}
a.add(906, 900, _("treeapp reboot"),				"javascript:rebootRouter(document.rebootForm, 'rebootReloader');");
document.write(a);
